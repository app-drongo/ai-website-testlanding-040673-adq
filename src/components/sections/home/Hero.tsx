...
const DEFAULT_HERO = {
  badge: 'New: Lightning-Fast Testing',
  title: 'Ship better code with',
  titleHighlight: 'TestLanding Pro',
  description:
    'Streamline your testing workflow with our minimal, powerful platform. Built for developers who value speed, reliability, and clean interfaces.',
  features: [
    'Zero-config setup',
  ...
  imageAlt: 'TestLanding dashboard interface',
